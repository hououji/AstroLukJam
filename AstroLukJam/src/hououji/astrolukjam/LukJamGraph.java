...
public class LukJamGraph implements  Constants{
...
//        int skyStart = (12-sky2ground[day%10] + 5)%12 ;
        ...
        for(int i=0; i<ly.eight.length; i++) {
        	System.out.print(skys[get10(ly.eight[i])] + grounds[get12(ly.eight[i])]);
        	System.out.print(" ") ;
        }
        System.out.println();
        ...
        // 七政行度
        for(int i=0; i< ly.resultSevenBodies.length; i++) {
